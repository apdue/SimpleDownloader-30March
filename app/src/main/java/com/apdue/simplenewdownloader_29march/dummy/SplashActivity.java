...
import com.apdue.simplenewdownloader_29march.util.JsonParser;
import com.apdue.simplenewdownloader_29march.util.OpenAdManager;
import com.apdue.simplenewdownloader_29march.util.OpenAdManagerSplash;
...
//        thread.start();
    ...
    private void initialization() {
        ...
        prf.setString(status_dummy_five_enabled, "true");
    ...
    private void startActivity() {
        ...
        if (new PrefManagerVideo(SplashActivity.this).getString(SplashActivity.status_dummy_one_enabled_fifteen).contains("true")) {
            ...
            intent = new Intent(SplashActivity.this, MainActivityFixed.class);
        }
