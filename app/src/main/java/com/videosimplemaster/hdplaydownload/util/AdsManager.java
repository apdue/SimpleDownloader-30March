...
import static com.videosimplemaster.hdplaydownload.dummy.SplashActivity.TAG_BANNERMAIN;
import static com.videosimplemaster.hdplaydownload.dummy.SplashActivity.TAG_BANNERMAINS;
import static com.videosimplemaster.hdplaydownload.dummy.SplashActivity.enable_adaptive_banner;
...
public class AdsManager {
        ...
        if (isInterstitialAdLoaded) {
            ...
            mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdImpression() {
                    ...
                    logInterstitialAdImpressionOnly(activity, prf.getString(SplashActivity.TAG_INTERSTITIALMAIN));
                }
    ...
    public static void loadBannerAdForNative(Activity context, ViewGroup bannerAdContainer) {
        if (new PrefManagerVideo(context).getString(enable_adaptive_banner).contains("true")) {
            AdView mAdView = null;
        ...
        if (SplashActivity.isConnectedToInternet(activity) && !new PrefManagerVideo(activity).getString(SplashActivity.TAG_NATIVEID).contains("sandeep")) {
            if (size == 0) {
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        ...
                        nativeAd.setOnPaidEventListener(new OnPaidEventListener() {
                            ...
                            public void onPaidEvent(@NonNull AdValue adValue) {
                                ...
                                logNativeAdImpression(activity, adValue, nativeAd, prf.getString(SplashActivity.TAG_NATIVEIDSMALL_fifteen));
                            }
                        });
                ...
                AdLoader adLoader = builder.withAdListener(new AdListener() {
                    ...
                    public void onAdImpression() {
                        super.onAdImpression();
                        logNativeAdImpressionOnly(activity, prf.getString(SplashActivity.TAG_NATIVEIDSMALL_fifteen));
                    }
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        ...
                        nativeAd.setOnPaidEventListener(new OnPaidEventListener() {
                            ...
                            public void onPaidEvent(@NonNull AdValue adValue) {
                                ...
                                logNativeAdImpression(activity, adValue, nativeAd, prf.getString(SplashActivity.TAG_NATIVEID));
                            }
                        });
                ...
                AdLoader adLoader = builder.withAdListener(new AdListener() {
                    ...
                    public void onAdImpression() {
                        super.onAdImpression();
                        logNativeAdImpressionOnly(activity, prf.getString(SplashActivity.TAG_NATIVEID));
                    }
                    @Override
                    public void onAdFailedToLoad(LoadAdError loadAdError) {
                ...
                builder.forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        ...
                        NativeAdView adView = (NativeAdView) activity.getLayoutInflater().inflate(R.layout.admob_native_full, null);
                        setupNativeAdView(nativeAd, adView, 1);
