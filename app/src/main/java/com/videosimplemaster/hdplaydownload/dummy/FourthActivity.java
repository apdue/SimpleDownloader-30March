...
public class FourthActivity extends AppCompatActivity {
    ...
    private void startActivity() {
        ...
        if (new PrefManagerVideo(this).getString(SplashActivity.status_dummy_five_enabled).contains("true") && !new PrefManagerVideo(FourthActivity.this).getString(SplashActivity.TAG_NATIVEID).contains("sandeep")) {
