...
public class ThirdActivity extends AppCompatActivity {
    ...
    private void startActivity() {
        ...
        } else if (new PrefManagerVideo(this).getString(SplashActivity.status_dummy_five_enabled).contains("true") && !new PrefManagerVideo(ThirdActivity.this).getString(SplashActivity.TAG_NATIVEID).contains("sandeep")) {
